  ...
  return (
    <section id="historia" className="relative z-10 bg-white py-24 px-6 overflow-hidden">
      <div className="mx-auto max-w-6xl">
        ...
        >
          {/* Col 1: Texto Narrativo — aparece primero en móvil */}
          ...
          <div className="order-2 h-72 w-full overflow-hidden rounded-3xl object-cover shadow-2xl md:order-2 md:h-[450px]">
            <img
